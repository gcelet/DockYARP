...
certificate in the file.** The preserved chain SHALL be sent during the TLS handshake for that host, not merely
retained on the loaded certificate object — loading and serving are both required for the chain to reach the
client.
